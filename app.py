...
def _tela_login():
    ...
    <div style="max-width:380px;margin:12vh auto 0;text-align:center">
        ...
        <p style="color:#6b7280;font-size:0.85rem;margin-bottom:18px">Acesso restrito — informe usuário e senha para continuar.</p>
    </div>
...
def _tela_trocar_senha(obrigatoria=True):
    ...
    <div style="max-width:380px;margin:12vh auto 0;text-align:center">
        <div style="font-size:2.2rem">🔑</div>
        <h2 style="margin:4px 0 2px">Trocar senha</h2>
    </div>
    """, unsafe_allow_html=True)
    if obrigatoria:
...
col_user, col_senha, col_logout = st.columns([4, 1.3, 1])
with col_user:
